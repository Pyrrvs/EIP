...
cc.Point.fromEvent = function(e) {
	...
	return (cc.ccp(e.offsetX || (e.originalEvent ? e.originalEvent.layerX : 0),
		e.offsetY || (e.originalEvent ? e.originalEvent.layerY : 0)))
};
...
b2Vec2.verticesFromArray = function(array, scale, pos) {

      var vertices = [];
      pos = pos || cc.ccp(0, 0);
      _.each(array, function(elem) {
          vertices.push(new b2Vec2((elem.x + pos.x) * scale.x, (elem.y + pos.y) * scale.y));
      });
      return (vertices);
};
