...
#       post :create, project_comment: { content: @project_comment.content, project_id: @project_comment.project_id, title: @project_comment.title, user_id: @project_comment.user_id }
#     end
...
#     put :update, id: @project_comment, project_comment: { content: @project_comment.content, project_id: @project_comment.project_id, title: @project_comment.title, user_id: @project_comment.user_id }
#     assert_redirected_to project_comment_path(assigns(:project_comment))
#   end
